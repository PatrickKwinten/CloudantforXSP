...
public class XPagesUtil {
    ...
    /*
     * public static ValueBinding getValueBinding() { FacesContext context =
     * FacesContext.getCurrentInstance(); Application application =
     * context.getApplication(); String value = "#document1.subject";
     * ValueBinding binding = application.createValueBinding(value);
     * 
     * return binding; }
     */
    public static String getBindingValueName(String bindingName) {
    ...
    public String getLangString(String fileName, String key, String lang) {
    	...
    	String locale = lang;
    	  ...
    	  try {
    	      ...
    	      prop.load(FacesContextEx.getCurrentInstance().getExternalContext().getResourceAsStream(locale + file));
